...
import com.kodeflap.desknot.Utils.hideKeyboard
import com.kodeflap.desknot.Utils.observeOnce
import com.kodeflap.desknot.data.TaskInfo
import com.kodeflap.desknot.databinding.FragmentListBinding
import com.kodeflap.desknot.presentation.view.fragment.recyclerlist.adapter.ListAdapter
...
class ListFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    override fun onCreateView(
        ...
        val pulseAnimation = AnimationUtils.loadAnimation(requireContext(), R.anim.fab_pulse)
        binding.floatingActionButton.startAnimation(pulseAnimation)
    ...
    private fun restoreDeletedItem(view: View, deletedItem: TaskInfo) {
        Snackbar.make(
            view,
